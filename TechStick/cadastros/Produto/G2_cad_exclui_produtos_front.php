              ...
              <div class="content">    
                     ...
                     <div class="exclui">
                            ...
                            <div class="form_txt">
                                   ...
                                   <br><br><p>Estoque:</p>
                                   <br><br><p>Preço:</p>
                                   <br><br><p>Código Visual:</p>
                                   <br><br><p>Margem Lucro:</p>
                            ...
                            <div class="form_campos">
                                   ...
                                   <input type="text" name="descricao" 
                                          value="<?php echo $lacuna['descricao']; ?>" 
                                          readonly><br><br><br>
                                   ...
                                   <input type="text" name="codvisual" 
                                          value="<?php echo $lacuna['codigovisual']; ?>" 
                                          readonly><br><br><br>
                            ...
                            <center>
                                   <div class="form_btn">
                                          ...
                                          <input type="button" value="Editar" onclick="location.href='G2_cad_altera_produtos_front.php?id_produto=<?php echo $id_produto ?>';">
                                          <input type="button" value="Voltar" onclick="location.href='G2_cad_pesq_produtos_front.php';">
                                   </div>
                            </center>
